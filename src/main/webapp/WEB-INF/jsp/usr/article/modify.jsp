			...
			<form action="doModify" method="POST" onsubmit="modifyForm_onSubmit(this); return false;">
				...
				<div class="table-box-type">
					<table>
						...
						<tr>
							<th>제목</th>
							<td><input class="input" type="text" name="title" value= ${article.title } /></td>
						</tr>
						<tr>
							<th>내용</th>
							<td><textarea class="textarea textarea-xs" name="body">${article.body }</textarea></td>
						</tr>
						<tr>
							<td colspan="2"><button class="btn btn-neutral">수정</button></td>
